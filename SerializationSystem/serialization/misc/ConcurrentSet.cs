...
namespace Serialization.Internal {
    internal class ConcurrentSet<T> : ISet<T> {
        ...
        public ICollection<T> Values => dictionary.Keys;
        ...
        public bool Contains(Func<T, bool> predicate) => dictionary.Keys.Any(predicate);
        ...
        public T[] ToArray() => dictionary.Keys.ToArray();
        public bool TryAdd(T item) => dictionary.TryAdd(item, default);
        public bool TryRemove(T item) => dictionary.TryRemove(item, out _);
    }
}